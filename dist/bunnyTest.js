...
function test(gl, width, height) {
  ...
  geometry.attr('aNormal', normals.vertexNormals(box.cells, box.positions));
  ...
  //program = makeProgram()
  var shader = glShader(gl, fs.readFileSync('./shaders/bunny.vert', 'utf8'), fs.readFileSync('./shaders/bunny.frag', 'utf8'));
